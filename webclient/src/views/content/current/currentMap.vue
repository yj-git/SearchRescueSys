...
export default class CurrentMap extends Vue {
    ...
    // http://localhost:8082/geoserver/SearchRescue/wms?service=WMS&version=1.1.0&request=GetMap&layers=SearchRescue:view_nmefc_wind&styles=&bbox=99.9,-0.1,150.10000000000002,50.1&width=768&height=767&srs=EPSG:4326&format=application/openlayers#toggle
    ...
    onCurrent(val: string) {
        ...
        const myself = this
        const defaultCurrent = '2016-07-20T12:00:00.0Z'
