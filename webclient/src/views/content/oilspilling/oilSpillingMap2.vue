<template>
  <div id="rescue-map">
    <div id="top-models">
      <!-- TODO:[*] 19-111-21 加入顶部基本信息栏 
      不直接调用DataBox组件-->
      <!-- <DataBox></DataBox>
      <DataBox></DataBox>
      <DataBox></DataBox>-->
      <RescueTopModels></RescueTopModels>
    </div>
    ...
    <div id="bottom-timebar">time bar</div>
  </div>
</template>
<script lang="ts">
...
import RescueTopModels from "@/views/members/bar/oilTopModels.vue";
import OilLeftModels from "@/views/members/bar/oilLeftModels.vue";
import {
...
#rescue-map {
  ...
  // 中间的content（主要包含左侧的风和流的框以及右侧占大部分区域的地图）
  #center-content {
    display: flex;
    flex: 6;
